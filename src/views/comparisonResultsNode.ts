...
export class ComparisonResultsNode extends ExplorerNode {
    ...
    async getChildren(): Promise<ExplorerNode[]> {
        ...
        const filesQueryFn = () => Container.git.getDiffStatus(this.uri.repoPath!, ref1, ref2);
        ...
        this.children = [
            ...
            new StatusFilesResultsNode(this.uri.repoPath!, ref1, ref2, filesLabelFn, filesQueryFn, this.explorer)
        ];
